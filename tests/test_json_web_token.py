...
from flask_azure_oauth.errors import (
    ApiAuthTokenClaimUntrustedIssuerError,
    ApiAuthTokenClaimMissingError,
    ApiAuthTokenClaimInvalidIssuedAt,
    ApiAuthTokenClaimInvalidNotBefore,
    ApiAuthTokenClaimInvalidExpiry,
    ApiAuthTokenClaimInvalidClientApplication,
    ApiAuthTokenClaimInvalidAudience,
)
...
class FlaskOAuthProviderJWTTestCase(FlaskOAuthProviderBaseTestCase):
    ...
    def test_auth_untrusted_token_issuer(self):
        ...
        # Generate JWT
        token_payload = {"aud": None, "exp": None, "iat": None, "iss": "invalid", "nbf": None, "sub": None, "azp": None}
        token = self._create_auth_token(payload=token_payload)
